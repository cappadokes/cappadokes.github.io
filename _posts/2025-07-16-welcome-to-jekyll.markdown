---
layout: post
title:  "A PhD's Apology"
date:   2025-07-16 10:28:38 +0300
...
>
> You can use this text to get to know me as well as [`idealloc`](https://www.github.com/cappadokes/idealloc), my most important professional achievement to date. If popularized treatments are not your thing, you may find a full technical report on `idealloc` [here](/assets/files/work_sample.pdf). Me myself am more interested in the philosophical stuff.
...
My graduate studies that year followed this same course from hubris to humility. Scattered across diary entries, as well as in online discussions with colleagues, one can to this day find my old self announcing that 2024 was destined to grant me greatness. I would get published at [ASPLOS](https://www.asplos-conference.org/), one of the premier conferences in my field, write the thesis, get the PhD. None of that happened. The only person from our house who graduated last year was my little sister. The only way I attended ASPLOS was by failing spectacularly at [a co-located programming contest](https://github.com/asplos-contest/2025/blob/main/misc/SCHEDULE.md). 2024 taught me that neither was I the center of the world, nor did I want to be, or should be.
...
1. Proceed with today’s public defense.
2. Submit [my dissertation’s text](https://lirias.kuleuven.be/4239233&lang=en) *once and for all* to KUL’s institutional repository, after acting upon the minor changes suggested by the Committee.
...
![Real title Slide](/assets/images/phdefense/1.jpg)
...
![Part I Cover](/assets/images/phdefense/2.jpg)

Let us start by introducing our topic.

![High Intro](/assets/images/phdefense/3.jpg)
...
![Frag Intro](/assets/images/phdefense/4.jpg)
...
![Tut](/assets/images/phdefense/5.jpg)
...
2. If we drew a rectangle around the whole arrangement, the height of that rectangle would be the smallest possible.
...
![Contribs](/assets/images/phdefense/7.jpg)
...
![Motivs](/assets/images/phdefense/8.jpg)
...
![Obstacles](/assets/images/phdefense/9.jpg)
...
![SOTA](/assets/images/phdefense/10.jpg)
...
![Spoiler](/assets/images/phdefense/11.jpg)

And since we’re talking about results, let’s use some evidence to back my claims. What we have here is six histograms. A histogram visualizes the distribution of data. In our case, that data is fragmentation (recall that this means wasted memory). Each colored bar in the histogram represents a different static memory planning implementation. The blue one is `idealloc`, my solution. The orange one comes from [XLA](https://github.com/openxla/xla/tree/896c0289645e87e42d2e552c0be2b41d0b886adb), an open-source project backed by Google. XLA uses a heuristic. The green one, [SOMAS](https://proceedings.mlsys.org/paper_files/paper/2023/hash/676d8419c61f299feb88c28b40edd3b1-Abstract-mlsys2023.html), was published by researchers from Huawei. SOMAS executes multiple heuristics and picks the one yielding the lowest fragmentation. In red we have an isomorphism-based solution from [TVM](https://dada.cs.washington.edu/research/tr/2017/12/UW-CSE-17-12-01.pdf), a deep learning compiler from the Apache Foundation. And finally in purple, we have [minimalloc](https://github.com/google/minimalloc), another Google project which is already deployed in the company’s Pixel devices. minimalloc also uses an isomorphism. Each histogram corresponds to a different benchmark, a different input set of rectangles. The more to the left a bar ends up along the histogram’s horizontal axis, the better it performed in terms of fragmentation. We see for instance that the solution by TVM delivered zero fragmentation in the top left benchmark. XLA wasted gigabytes of memory at the bottom center benchmark, and so on. The following points can be made here:

1. Some implementations are missing from some benchmarks. They are missing because they either crashed or timed out. Only `idealloc` and XLA participate everywhere.
2. No solution is best in every benchmark. XLA and SOMAS, which are heuristics-based, waste the most memory most of the time.
3. Only `idealloc` has consistently the lowest, or second-lowest, fragmentation.
...
![Part II](/assets/images/phdefense/12.jpg)
...
![Flow](/assets/images/phdefense/13.jpg)
...
![HowTo](/assets/images/phdefense/15.jpg)
...
![WhatdIDo](/assets/images/phdefense/16.jpg)
...
![MoResults](/assets/images/phdefense/17.jpg)
...
1. `idealloc`’s users can rest assured that they pay the minimum amount of time per iteration.
2. Faster heuristics exist, but they suffer from high fragmentation.
3. More memory-efficient isomorphisms exist, but they suffer from lack of scalability and high latency.

![Futureproof](/assets/images/phdefense/18.jpg)
...
![FinPart](/assets/images/phdefense/19.jpg)
...
![Dict](/assets/images/phdefense/20.jpg)
...
![Dict2](/assets/images/phdefense/21.jpg)
...
> 1. Philosophy is the art and discipline of living well.
> 2. To have lived well is to look back, right before the end of your life, and find in what you see the courage to face death. A life well lived is a life left behind peacefully.
...
![End](/assets/images/phdefense/22.jpg)